...
const getStartedBtn = document.querySelector('.button'); // selects the button
const overlay = document.getElementById('page-transition');

getStartedBtn.addEventListener('click', function(e) {
    e.preventDefault(); // stop immediate navigation
    overlay.classList.add('active'); // trigger unroll animation

    setTimeout(() => {
        window.location.href = 'all-products.html'; // navigate after animation
